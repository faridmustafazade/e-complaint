...
const TableHeader = ({ name, width, onClick, sortOrder, sortBy, title }) => {
  return (
    <div
      onClick={onClick}
      className={`${width} text-sm lg:text-base flex items-center justify-between border-r pl-5 py-5 pr-2`}
    >
      <p>{name}</p>
      {/* {sortBy === title ? (
